...
public class Settings extends AppCompatActivity {
    ...
    //get string warna yang akan digunakan untuk mengubah shape color
    ...
    //get id dari warna yang nantinya digunakan
    ...
    public void pilihColour(View view) {
        //set title dari alert dialog menjadi Shape Color
        alert.setTitle("Shape Color");
        //create view baru
        View view1 = getLayoutInflater().inflate(R.layout.settings, null);
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                int a = radG.getCheckedRadioButtonId(); //get id radio button dari warna yang dipiih
                switch (a){
                    case R.id.red:
                        colorid = R.color.red;
                        break;
        ...
        //ketika meklik Cancel di alert dialog
